      ...
      <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
            ...
            пътувания, преглед на участници и модериране на груповото
            съдържание.
          </p>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link
            ...
            className="inline-flex h-11 min-w-40 items-center justify-center whitespace-nowrap rounded-md border border-emerald-200 bg-white px-5 text-sm font-semibold text-emerald-800 shadow-sm transition hover:bg-emerald-50"
          >
            Създай група
          </Link>
          <Link
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  {group.description ??
                    "Няма добавено описание за тази група."}
                </p>
              </div>
            </div>
